...
Log.Logger = new LoggerConfiguration()
    .WriteTo.Console()
    .WriteTo.File("logs/gpstriangulation-.txt", rollingInterval: RollingInterval.Day)
    .Enrich.FromLogContext()
    .Enrich.WithProperty("Application", "GpsTriangulation")
    .CreateLogger();
...
try
{
    ...
    app.MapGet("/", () => "Hello GpsTriangulation!").AllowAnonymous();
    ...
    Log.Information("Starting GpsTriangulation API");
    await app.RunAsync();
}
catch (Exception ex)
{
